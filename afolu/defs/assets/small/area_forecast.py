...
def area_forecast(
    ...
    if "area" in context.selected_output_names:
        yield dg.Output(total_area, output_name="area")  # pyright: ignore[reportReturnType]

    if "area_frac" in context.selected_output_names:
        yield dg.Output(total_area_frac.set_index("label"), output_name="area_frac")  # pyright: ignore[reportReturnType]
